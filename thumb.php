...
<?php
	...
	if ($_POST) {
			...
			($_FILES["file"]["type"] == "image/jpeg")) {
              ...
              // $save=file_put_contents("$url", fopen("http://localhost:8080/dashboard/start/vps/new%20login/uploads/", 'r'));
              // if ($save) {
              //   echo "done";
              // }
              ...
              // $url="http://localhost:8080/dashboard/start/vps/new%20login/uploads";
              // echo "done";
